...
export const WIDGET_REGISTRY = [
  ...
  {
    id: 'v2_shift_arc',
    label: 'Shift Progress Arc',
    description: 'Live shift completion gauge with clock-in/out. Backend owns all computation.',
    group: 'v2_core',
    priority: 1,
    defaultWidth: 'full',
    defaultHeight: 'auto',
  ...
  },
  {
    ...
    description: 'Birthdays, work anniversaries, and wedding anniversaries in the next 7 days',
    group: 'v2_core',
    priority: 5,
    defaultWidth: 'third',
    defaultHeight: 'auto',
  ...
  },
  {
    ...
    dependencies: ['tasks', 'leaves', 'tickets'],
  ...
  },
  {
    ...
    category: 'ops',
    refreshStrategy: 'periodic',
    dependencies: ['attendances', 'employees'],
  ...
  },
  {
    ...
    category: 'personal',
    refreshStrategy: 'live',
    dependencies: ['attendances', 'tasks', 'employees'],
  ...
  },
  {
    ...
    category: 'actions',
    refreshStrategy: 'live',
    dependencies: ['leaves', 'regularizations', 'tasks', 'tickets'],
  ...
  // — V2 Stat Cards —
  {
    ...
    category: 'stats',
    refreshStrategy: 'periodic',
    dependencies: ['leaves', 'regularizations'],
  ...
  },
  {
    ...
    category: 'payroll',
    refreshStrategy: 'periodic',
    dependencies: ['payroll_runs'],
    needsData: ['payroll_runs'],
  },
  {
  ...
  },
  {
    ...
    category: 'exec',
    refreshStrategy: 'periodic',
    dependencies: ['payroll_runs', 'payrolls'],
    needsData: ['payroll_runs', 'payrolls'],
  },
