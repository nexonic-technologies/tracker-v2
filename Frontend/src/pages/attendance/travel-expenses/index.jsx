      ...
      {policies.expenses?.update && (
        <div className="flex gap-2 border-b border-hairline pb-px mb-2">
          <button
            ...
            className={`px-4 py-2 text-sm font-semibold border-b-2 transition-all ${activeTab === "my"
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-semibold border-b-2 transition-all ${activeTab === "pending"
                ? "border-[var(--module-payroll)] text-[var(--module-payroll)]"
                : "border-transparent text-ink-muted hover:text-ink"
              }`}
          >
