...
export default function V2AlertBanner({ alerts = [] }) {
  ...
  return (
    <div className="relative group w-full">
      <div
        className={`h-10 flex items-center justify-between gap-2.5 px-3.5 border rounded-tracker-md text-xs font-medium transition-all duration-300 select-none cursor-pointer ${severityClass}`}
        role="alert"
      >
