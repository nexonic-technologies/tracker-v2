        ...
        {grid.length > 0 && (
          <div className="flex items-center gap-1 mb-3 bg-surface-1/60 p-1 rounded-xl border border-hairline-soft">
            <button
              ...
              className={`flex-1 py-1 text-[10px] font-bold rounded-lg transition-colors cursor-pointer text-center ${
                filter === 'ALL'
            ...
            <button
              ...
              className={`flex-1 py-1 text-[10px] font-bold rounded-lg transition-colors cursor-pointer text-center flex items-center justify-center gap-1 ${
                filter === 'PRESENT'
                  ? 'bg-surface text-emerald-600 dark:text-emerald-400 shadow-xs'
                  : 'text-ink-muted hover:text-ink'
              }`}
            >
              <CheckCircle2 size={11} /> In ({checkedInList.length})
            </button>
            <button
            ...
            >
              <UserX size={11} /> Pending ({pendingList.length})
            </button>
          </div>
        )}
